...
///---END-------------------------------------------------
        ...
        return {
            startWebCam: function(videoid){qrcode.startWebCam(videoid);},
            stopWebCam: function(videoid){qrcode.stopWebCam();},
            startScan: function(videoid){qrcode.startScan(videoid);},
            stopScan: function(videoid){qrcode.stopScan();},
            setCallback: function(callback){qrcode.callback=callback;},
            decode: function(canvas){qrcode.decode(canvas)}
        };
    }
);
